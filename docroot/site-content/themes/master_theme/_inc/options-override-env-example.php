...
/***
	...
	Override code for options which should be overridden in a single environment. COPY this file to options-override-env.php.
...
*-------------------------------------------------------------------------------------*/
/*
function nbcupress_full_nbcupress_pixelman_settings(){
	$nbcupress_pixelman_settings = array( 
		'nbcupress_pixelman_onoff' => '1', 
		'nbcupress_pixelman_header' => 'header-pix',
		'nbcupress_pixelman_footer' => 'foot-pix'
	);
	return $nbcupress_pixelman_settings;
}
$filter = new nbcupress_CallbackFilter(array('nbcupress_pixelman_settings' => nbcupress_full_nbcupress_pixelman_settings()));
